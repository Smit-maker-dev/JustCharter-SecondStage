import { ArrowRight, Plane, Users, Package, Clock, ShieldCheck, HeartPulse, CheckCircle2 } from 'lucide-react';
  ...
  const detailedServices = [
    {
      ...
      description: "Experience the ultimate in bespoke travel. Our private jet charters offer on-demand access to a global fleet of light, midsize, and heavy jets. Skip the commercial lines, fly directly to your destination on your own schedule, and enjoy custom catering and onboard amenities.",
      features: [
    ...
    },
    {
      ...
      description: "When coordinating travel for corporate events, sports teams, or large family gatherings, our group charter services ensure everyone travels together comfortably. We arrange dedicated airliners with custom seating configurations and branding options.",
      features: [
    ...
    },
    {
      ...
      description: "When every second counts, our global network provides rapid response air medical transport. Fully equipped with intensive care units and staffed by specialized medical teams, we ensure safe and efficient transfers back home or to specialized facilities.",
      features: [
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/CH.SZ.Stoos_Fronalpstock_Sequence_Rescue-Helicopter_REGA_16K_16x9-R.jpg/1280px-CH.SZ.Stoos_Fronalpstock_Sequence_Rescue-Helicopter_REGA_16K_16x9-R.jpg"
    },
    {
      id: "cargo-charter",
      ...
      description: "For urgent, oversized, hazardous, or high-value freight that commercial airlines can't handle, our cargo charter solutions provide guaranteed delivery. We match your specific freight requirements with the ideal aircraft.",
      features: [
    ...
    },
    {
      ...
      description: "Take advantage of aircraft repositioning flights at significantly reduced charter rates—often up to 75% off the standard price. Spontaneous travelers can enjoy the full private jet experience at a fraction of the cost.",
      features: [
    ...
    },
    {
      ...
      description: "We provide comprehensive operational support, maintenance oversight, and crew management for private aircraft owners. Enjoy the benefits of ownership without the day-to-day administrative burdens.",
      features: [
    ...
    <div className="bg-[#F5F5F5] dark:bg-neutral-900 min-h-screen pt-20 md:pt-24 pb-16 md:pb-24">
      <div className="max-w-[88rem] mx-auto px-4 sm:px-6 mt-8 md:mt-16 mb-12 md:mb-24">
        <h1 className="text-4xl md:text-5xl lg:text-7xl font-medium leading-[1.1] md:leading-tight mb-6 md:mb-8" style={{ letterSpacing: '-0.04em' }}>
          Aviation Solutions<br/>Without Limits.
        </h1>
        <p className="text-black/60 dark:text-white/60 text-lg md:text-xl max-w-2xl leading-relaxed">
          From executing meticulous corporate travel to managing life-saving medical evacuations, explore our complete suite of global aviation services.
        </p>
      </div>
        ...
        {detailedServices.map((service, index) => (
          <div key={service.id} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12 lg:gap-20`}>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-3xl md:text-4xl font-medium mb-6" style={{ letterSpacing: '-0.03em' }}>
                {service.title}
              </h2>
              ...
              <button className="inline-flex items-center gap-3 bg-white dark:bg-neutral-950 border border-black/10 dark:border-white/20 text-black dark:text-white text-base font-medium px-8 py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-200">
                Inquire Now
              </button>
            </div>
          </div>
      ...
      <div className="max-w-[88rem] mx-auto px-4 sm:px-6 mt-20 md:mt-32">
        <div className="bg-black text-white rounded-[2rem] md:rounded-3xl p-8 sm:p-12 md:p-20 text-center flex flex-col items-center">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-xl mx-auto mb-8 md:mb-10">
            Contact our dedicated concierge team today to discuss your next journey or to learn more about our comprehensive services.
          </p>
          <button className="inline-flex items-center gap-3 bg-white dark:bg-neutral-950 text-black dark:text-white text-lg font-medium px-8 py-3.5 rounded-full hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors duration-200">
            Contact Us
