...
export default function Services() {
  ...
  return (
    <div className="bg-[#F5F5F5] min-h-screen pt-24 pb-24">
      ...
      <div className="max-w-[88rem] mx-auto px-6 flex flex-col gap-32">
        {detailedServices.map((service, index) => (
          <div key={service.id} className={`flex flex-col ${index % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-12 lg:gap-20`}>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <button className="inline-flex items-center gap-3 bg-white border border-black/10 text-black text-base font-medium px-8 py-3 rounded-full hover:bg-black hover:text-white transition-colors duration-200">
                Inquire Now
              </button>
            </div>
          </div>
      ...
      <div className="max-w-[88rem] mx-auto px-6 mt-32">
        <div className="bg-black text-white rounded-3xl p-12 md:p-20 text-center flex flex-col items-center">
          ...
          <button className="inline-flex items-center gap-3 bg-white text-black text-lg font-medium px-8 py-3.5 rounded-full hover:bg-gray-100 transition-colors duration-200">
            Contact Us
